...
//============================================================================
	...
	{
		while (!(WF_SPI_PORT->SR & SPI_I2S_FLAG_TXE) || !(WF_SPI_PORT->SR & SPI_I2S_FLAG_RXNE));
	}
	#define SPI_ON_BIT
#else
...
static void ConfigureSpiMRF24W(void)
{
    ...
    /* set the clock divider            */
		...
		SPI_InitStructure.SPI_BaudRatePrescaler = WF_SPI_SCALE;
		SPI_InitStructure.SPI_FirstBit = SPI_FirstBit_MSB;
		SPI_InitStructure.SPI_CRCPolynomial = 0;
		SPI_Init(WF_SPI_PORT, &SPI_InitStructure);

		SPI_Cmd(WF_SPI_PORT, ENABLE);
